...
public class WesternUnionBeneficaryDataTable implements Serializable{
	...
	public String toString() {
		return "WUBeneficaryDataTable [beneficaryMasterSeqId=" + beneficaryMasterSeqId + ", applicationCountryId=" + applicationCountryId + ", firstName=" + firstName + ", secondName=" + secondName + ", thirdName=" + thirdName + ", fourthName=" + fourthName + ", fiftheName="
				+ fiftheName + ", firstNameLocal=" + firstNameLocal + ", secondNameLocal=" + secondNameLocal + ", thirdNameLocal=" + thirdNameLocal + ", fourthNameLocal=" + fourthNameLocal + ", fifthNameLocal=" + fifthNameLocal + ", benificaryStatusId=" + benificaryStatusId + ", nationality="
				+ nationality + ", nationalityName=" + nationalityName + ", dateOfBirth=" + dateOfBirth + ", yearOfBirth=" + yearOfBirth + ", age=" + age + ", occupation=" + occupation + ", stateName=" + stateName + ", districtName=" + districtName + ", cityName=" + cityName + ", noOfRemittance="
				+ noOfRemittance + ", isActive=" + isActive + ", createdBy=" + createdBy + ", createdDate=" + createdDate + ", modifiedBy=" + modifiedBy + ", modifiedDate=" + modifiedDate + ", countryId=" + countryId + ", countryName=" + countryName + ", benificaryStatusName="
				+ benificaryStatusName + ", remarks=" + remarks + ", benificaryCountry=" + benificaryCountry + ", bankBranchName=" + bankBranchName + ", bankAccountNumber=" + bankAccountNumber + ", accountStatus=" + accountStatus + ", branchCode=" + branchCode + ", bankCode=" + bankCode
				+ ", serviceProvider=" + serviceProvider + ", serviceGroupId=" + serviceGroupId + ", relationShipName=" + relationShipName + ", relationShipId=" + relationShipId + ", customerId=" + customerId + ", arbenificaryName=" + arbenificaryName + ", bankId=" + bankId + ", branchId="
				+ branchId + ", serviceGroupCode=" + serviceGroupCode + ", bankName=" + bankName + ", currencyId=" + currencyId + ", benificaryName=" + benificaryName + ", currencyName=" + currencyName + ", currencyQuoteName=" + currencyQuoteName + ", beneficiaryAccountSeqId="
				+ beneficiaryAccountSeqId + ", beneficiaryRelationShipSeqId=" + beneficiaryRelationShipSeqId + ", benificaryCountryName=" + benificaryCountryName + ", serviceGroupName=" + serviceGroupName + ", telphoneNum=" + telphoneNum + ", location=" + location + ", booDisabled=" + booDisabled
				+ "]";
	}
