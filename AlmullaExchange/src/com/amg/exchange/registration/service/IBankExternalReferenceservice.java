...
public interface IBankExternalReferenceservice {
	...
	public List<BankExternalReferenceHead> getAllRecordsfromHead(boolean fetchAll, BigDecimal countryId, BigDecimal bankId);
    ...
    public  List<BankExternalReferenceHead>  getDuplicateCheckList(BigDecimal countryId, BigDecimal bankId,BigDecimal appContryId,BigDecimal beneBankId);
