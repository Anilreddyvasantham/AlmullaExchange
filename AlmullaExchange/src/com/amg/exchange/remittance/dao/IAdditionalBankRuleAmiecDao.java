...
public interface IAdditionalBankRuleAmiecDao {
...
//	public List<AdditionalBankRuleAmiec> getamiecDescriptionList(String amiecDescription);
	...
	public List<AdditionalBankRuleAddData> populateAdditionalDescription(BigDecimal countryId,BigDecimal bankId,String flexField,String amiecCode);	
