...
public interface IGeneralDao<T> {
	...
	//To get the All Type of Banks From Bank Applicability According to CountryId and BanksId
	...
	//To get Bank Name according to languageId and BankId 
	...
	public HashMap<String, String> getNextDocumentRefNumber(int countryId, int companyId,
			int documentId, int financialYear, String processIn,BigDecimal branchId)throws AMGException;
