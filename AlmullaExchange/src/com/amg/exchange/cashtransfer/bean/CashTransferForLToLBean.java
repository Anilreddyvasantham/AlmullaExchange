...
@Component("cashTransferForLToLBean")
@Scope("session")
public class CashTransferForLToLBean<T> implements Serializable {

	private static final Logger log = Logger
			.getLogger(CashTransferForLToLBean.class);
	...
	private Boolean readOnlyInputThousands = false;
	private Boolean readOnlyInputFiveHundreds = false;
	private Boolean readOnlyInputTwoHundreds = false;
	private Boolean readOnlyInputHundreds = false;
	private Boolean readOnlyInputFifties = false;
	private Boolean readOnlyInputTwenties = false;
	private Boolean readOnlyInputTens = false;
	private Boolean readOnlyInputFives = false;
	private Boolean readOnlyInputOnes = false;
	private Boolean readOnlyInputPointfives = false;
	private Boolean readOnlyInputPointTwoFives = false;
	private Boolean readOnlyInputPointOnes = false;
	private Boolean readOnlyInputPointZeroFives = false;
	...
	private List<CashTransferForLToLBeanDataTable> cashTransferSampleList = new ArrayList<CashTransferForLToLBeanDataTable>(); // sample
																																// list
																																// for
																																// displaying
	...
	public Boolean getReadOnlyInputThousands() {
		return readOnlyInputThousands;
	}

	public void setReadOnlyInputThousands(Boolean readOnlyInputThousands) {
		this.readOnlyInputThousands = readOnlyInputThousands;
	}

	public Boolean getReadOnlyInputFiveHundreds() {
		return readOnlyInputFiveHundreds;
	}

	public void setReadOnlyInputFiveHundreds(Boolean readOnlyInputFiveHundreds) {
		this.readOnlyInputFiveHundreds = readOnlyInputFiveHundreds;
	}

	public Boolean getReadOnlyInputTwoHundreds() {
		return readOnlyInputTwoHundreds;
	}

	public void setReadOnlyInputTwoHundreds(Boolean readOnlyInputTwoHundreds) {
		this.readOnlyInputTwoHundreds = readOnlyInputTwoHundreds;
	}

	public Boolean getReadOnlyInputHundreds() {
		return readOnlyInputHundreds;
	}

	public void setReadOnlyInputHundreds(Boolean readOnlyInputHundreds) {
		this.readOnlyInputHundreds = readOnlyInputHundreds;
	}

	public Boolean getReadOnlyInputFifties() {
		return readOnlyInputFifties;
	}

	public void setReadOnlyInputFifties(Boolean readOnlyInputFifties) {
		this.readOnlyInputFifties = readOnlyInputFifties;
	}

	public Boolean getReadOnlyInputTwenties() {
		return readOnlyInputTwenties;
	}

	public void setReadOnlyInputTwenties(Boolean readOnlyInputTwenties) {
		this.readOnlyInputTwenties = readOnlyInputTwenties;
	}

	public Boolean getReadOnlyInputTens() {
		return readOnlyInputTens;
	}

	public void setReadOnlyInputTens(Boolean readOnlyInputTens) {
		this.readOnlyInputTens = readOnlyInputTens;
	}

	public Boolean getReadOnlyInputFives() {
		return readOnlyInputFives;
	}

	public void setReadOnlyInputFives(Boolean readOnlyInputFives) {
		this.readOnlyInputFives = readOnlyInputFives;
	}

	public Boolean getReadOnlyInputOnes() {
		return readOnlyInputOnes;
	}

	public void setReadOnlyInputOnes(Boolean readOnlyInputOnes) {
		this.readOnlyInputOnes = readOnlyInputOnes;
	}

	public Boolean getReadOnlyInputPointfives() {
		return readOnlyInputPointfives;
	}

	public void setReadOnlyInputPointfives(Boolean readOnlyInputPointfives) {
		this.readOnlyInputPointfives = readOnlyInputPointfives;
	}

	public Boolean getReadOnlyInputPointTwoFives() {
		return readOnlyInputPointTwoFives;
	}

	public void setReadOnlyInputPointTwoFives(Boolean readOnlyInputPointTwoFives) {
		this.readOnlyInputPointTwoFives = readOnlyInputPointTwoFives;
	}

	public Boolean getReadOnlyInputPointOnes() {
		return readOnlyInputPointOnes;
	}

	public void setReadOnlyInputPointOnes(Boolean readOnlyInputPointOnes) {
		this.readOnlyInputPointOnes = readOnlyInputPointOnes;
	}

	public Boolean getReadOnlyInputPointZeroFives() {
		return readOnlyInputPointZeroFives;
	}

	public void setReadOnlyInputPointZeroFives(
			Boolean readOnlyInputPointZeroFives) {
		this.readOnlyInputPointZeroFives = readOnlyInputPointZeroFives;
	}
	...
	public BigDecimal getToLocation() {
		return toLocation;
	}

	public void setToLocation(BigDecimal toLocation) {
	...
	public void cashierLToLNavigation() {
		clearAll();
		...
		try {
			loginLogoutHistoryUtil.saveLoginLogoutDetails(sessionManage.getCountryId(), sessionManage.getUserType(), sessionManage.getUserName(), "CashTransferFromLocationToLocation.xhtml");
			FacesContext
					.getCurrentInstance()
					.getExternalContext()
					.redirect(
							"../cashtransfer/CashTransferFromLocationToLocation.xhtml");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void fromToLocationCountryBranch() {
		try {
			...
			List<CountryBranch> lstToCountryBranch = generalService
					.getBranchDetailsForToLocation(
							sessionManage.getCountryId(), getFromLocation());
	...
	public void onCellEditThousands(
			CashTransferForLToLBeanDataTable cashTransObj) {
		try {
	...
	// if i select transfer option
	public void transferOptionSelection() {
		try {
			getAllCurrencyDenominationFromStock();
			if (getTransferOption().equalsIgnoreCase("ALL")) {
				// make all data table input fields read only
				makeReadOnly();
				// if i select transfer option to ALL calculate with all stock
				// values
				calculateAllStock();
			} else {
				// make all data table input fields not read only
				makeUnReadOnly();
	...
	// if i select transfer option to ALL calculate with all stock values
	public void calculateAllStock() {
		calTotalTransfer = null;
		for (CashTransferForLToLBeanDataTable cashTransferDTObj : cashTransferDataTableList) {
			if (cashTransferDTObj.getThousands() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputThousands(null);
			} else {
				cashTransferDTObj.setInputThousands(cashTransferDTObj
						.getThousands());
			}
			if (cashTransferDTObj.getFiveHundreds() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputFiveHundreds(null);
			} else {
				cashTransferDTObj.setInputFiveHundreds(cashTransferDTObj
						.getFiveHundreds());
			}
			if (cashTransferDTObj.getTwoHundreds() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputTwoHundreds(null);
			} else {
				cashTransferDTObj.setInputTwoHundreds(cashTransferDTObj
						.getTwoHundreds());
			}
			if (cashTransferDTObj.getHundreds() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputHundreds(null);
			} else {
				cashTransferDTObj.setInputHundreds(cashTransferDTObj
						.getHundreds());
			}
			if (cashTransferDTObj.getFifties() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputFifties(null);
			} else {
				cashTransferDTObj.setInputFifties(cashTransferDTObj
						.getFifties());
			}
			if (cashTransferDTObj.getTwenties() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputTwenties(null);
			} else {
				cashTransferDTObj.setInputTwenties(cashTransferDTObj
						.getTwenties());
			}
			if (cashTransferDTObj.getTens() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputTens(null);
			} else {
				cashTransferDTObj.setInputTens(cashTransferDTObj.getTens());
			}
			if (cashTransferDTObj.getFives() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputFives(null);
			} else {
				cashTransferDTObj.setInputFives(cashTransferDTObj.getFives());
			}
			if (cashTransferDTObj.getOnes() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputOnes(null);
			} else {
				cashTransferDTObj.setInputOnes(cashTransferDTObj.getOnes());
			}
			if (cashTransferDTObj.getPointfives() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputPointfives(null);
			} else {
				cashTransferDTObj.setInputPointfives(cashTransferDTObj
						.getPointfives());
			}
			if (cashTransferDTObj.getPointTwoFives() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputPointTwoFives(null);
			} else {
				cashTransferDTObj.setInputPointTwoFives(cashTransferDTObj
						.getPointTwoFives());
			}
			if (cashTransferDTObj.getPointOnes() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputPointOnes(null);
			} else {
				cashTransferDTObj.setInputPointOnes(cashTransferDTObj
						.getPointOnes());
			}
			if (cashTransferDTObj.getPointZeroFives() == BigDecimal.ZERO) {
				cashTransferDTObj.setInputPointZeroFives(null);
			} else {
				cashTransferDTObj.setInputPointZeroFives(cashTransferDTObj
						.getPointZeroFives());
			}

			if ((cashTransferDTObj.getInputThousands() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputThousands())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj.setInputThousandsAdjAmount(cashTransferDTObj
						.getInputThousands().multiply(Constants.THOUSAND));
			}
			if ((cashTransferDTObj.getInputFiveHundreds() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputFiveHundreds())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj
						.setInputFiveHundredsAdjAmount(cashTransferDTObj
								.getInputFiveHundreds().multiply(
										Constants.FIVE_HUNDRED));
			}
			if ((cashTransferDTObj.getInputTwoHundreds() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputTwoHundreds())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj
						.setInputTwoHundredsAdjAmount(cashTransferDTObj
								.getInputTwoHundreds().multiply(
										Constants.TWO_HUNDRED));
			}
			if ((cashTransferDTObj.getInputHundreds() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputHundreds())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj.setInputHundredsAdjAmount(cashTransferDTObj
						.getInputHundreds().multiply(Constants.HUNDRED));
			}
			if ((cashTransferDTObj.getInputFifties() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputFifties())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj.setInputFiftiesAdjAmount(cashTransferDTObj
						.getInputFifties().multiply(Constants.FIFTY));
			}
			if ((cashTransferDTObj.getInputTwenties() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputTwenties())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj.setInputTwentiesAdjAmount(cashTransferDTObj
						.getInputTwenties().multiply(Constants.TWENTY));
			}
			if ((cashTransferDTObj.getInputTens() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputTens())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj.setInputTensAdjAmount(cashTransferDTObj
						.getInputTens().multiply(Constants.TEN));
			}
			if ((cashTransferDTObj.getInputFives() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputFives())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj.setInputFivesAdjAmount(cashTransferDTObj
						.getInputFives().multiply(Constants.FIVE));
			}
			if ((cashTransferDTObj.getInputOnes() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputOnes())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj.setInputOnesAdjAmount(cashTransferDTObj
						.getInputOnes().multiply(Constants.ONE));
			}
			if ((cashTransferDTObj.getInputPointfives() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputPointfives())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj.setInputPointfivesAdjAmount(cashTransferDTObj
						.getInputPointfives().multiply(Constants.POINT_FIVE));
			}
			if ((cashTransferDTObj.getInputPointTwoFives() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputPointTwoFives())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj
						.setInputPointTwoFivesAdjAmount(cashTransferDTObj
								.getInputPointTwoFives().multiply(
										Constants.POINT_TWO_FIVE));
			}
			if ((cashTransferDTObj.getInputPointOnes() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputPointOnes())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj.setInputPointOnesAdjAmount(cashTransferDTObj
						.getInputPointOnes().multiply(Constants.POINT_ONE));
			}
			if ((cashTransferDTObj.getInputPointZeroFives() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getInputPointZeroFives())
					.compareTo(BigDecimal.ZERO) != 0) {
				cashTransferDTObj
						.setInputPointZeroFivesAdjAmount(cashTransferDTObj
								.getInputPointZeroFives().multiply(
										Constants.POINT_ZERO_FIVE));
			}

			// calculate all values
			calTotalTransfer = (cashTransferDTObj.getThousands() == null ? BigDecimal.ZERO
					: cashTransferDTObj.getThousands())
					.multiply(Constants.THOUSAND)
					.add((cashTransferDTObj.getFiveHundreds() == null ? BigDecimal.ZERO
							: cashTransferDTObj.getFiveHundreds())
			...
			cashTransferDTObj.setInputTotalTransfer(calTotalTransfer);
			calTotalTransfer = null;
	...
	public void makeReadOnly() {
		setReadOnlyInputThousands(true);
		setReadOnlyInputFiveHundreds(true);
		setReadOnlyInputTwoHundreds(true);
		setReadOnlyInputHundreds(true);
		setReadOnlyInputFifties(true);
		setReadOnlyInputTwenties(true);
		setReadOnlyInputTens(true);
		setReadOnlyInputFives(true);
		setReadOnlyInputOnes(true);
		setReadOnlyInputPointfives(true);
		setReadOnlyInputPointTwoFives(true);
		setReadOnlyInputPointOnes(true);
		setReadOnlyInputPointZeroFives(true);
	}

	// make all data table input fields not read only
	public void makeUnReadOnly() {
		setReadOnlyInputThousands(false);
		setReadOnlyInputFiveHundreds(false);
		setReadOnlyInputTwoHundreds(false);
		setReadOnlyInputHundreds(false);
		setReadOnlyInputFifties(false);
		setReadOnlyInputTwenties(false);
		setReadOnlyInputTens(false);
		setReadOnlyInputFives(false);
		setReadOnlyInputOnes(false);
		setReadOnlyInputPointfives(false);
		setReadOnlyInputPointTwoFives(false);
		setReadOnlyInputPointOnes(false);
		setReadOnlyInputPointZeroFives(false);
	 ...
	 * for(CashTransferForLToLBeanDataTable
	 * cashTransferDTObj1:cashTransferDataTableList){ if(
	 ...
	 * for(CashTransferForLToLBeanDataTable
	 * cashTransferDTObj:cashTransferDataTableList){ //save Cash Details
	 ...
	 * (),saveDocumentSerialID,acc_Month)); } } try { // save in cash header ,
	 * cash details and currency adjust
	 ...
	 * break; } } catch (Exception e) { log.error("Error Occured While Saving :"
	...
	public CashHeader saveCashHeader(BigDecimal documentNumber) {
		...
		document.setDocumentID(specialCustomerDealRequestService
				.getDocumentPk(new BigDecimal(
						Constants.DOCUMENT_CODE_FOR_CASH_TRANSFER_B_B)));
	...
	/*
	 * public CashDetails saveCashDetail(CashTransferForLToLBeanDataTable
	 * cashTransferDTObj,CashHeader cashHeader,BigDecimal documentNumber, int
	 * i){ CashDetails cashDetails=new CashDetails();
	 ...
	 * document.setDocumentID(specialCustomerDealRequestService
	 * .getDocumentPk(new
	 * BigDecimal(Constants.DOCUMENT_CODE_FOR_CASH_TRANSFER)));
	...
	public void getCalculateHeaderCurrency(
		...
		try {
			...
			if (currencyStockDataTable.getOneLakh() != null) {
				...
				currencyStockDataTable.setOneLakhAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getFiftyThousand() != null) {
				...
				currencyStockDataTable.setFiftyThousandAdj(modifySubTotal);
			}
			...
			if (currencyStockDataTable.getTwentyThousand() != null) {
				...
				modifySubTotal = modifySubTotal.add(currencyStockDataTable
						.getTwentyThousands().multiply(
								Constants.TWENTY_THOUSAND));
				currencyStockDataTable.setTwentyThousandAdj(modifySubTotal);
			}
			...
			if (currencyStockDataTable.getTenThousand() != null) {
				...
				currencyStockDataTable.setTenThousandAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getFiveThousand() != null) {
				...
				currencyStockDataTable.setFiveThousandAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getTwoThousand() != null) {
				...
				currencyStockDataTable.setTwoThousandAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getThousand() != null) {
				...
				currencyStockDataTable.setThousandAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getFiveHundred() != null) {
				...
				currencyStockDataTable.setFiveHundredAdj(modifySubTotal);
			}
			...
			if (currencyStockDataTable.getHundred() != null) {
				...
				currencyStockDataTable.setHundredAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getFifty() != null) {
				...
				currencyStockDataTable.setFiftyAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getTwenty() != null) {
				...
				currencyStockDataTable.setTwentyAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getTen() != null) {
				...
				currencyStockDataTable.setTenAdj(modifySubTotal);
			}
			...
			if (currencyStockDataTable.getFive() != null) {
				...
				currencyStockDataTable.setFiveAdj(modifySubTotal);
			}
			...
			if (currencyStockDataTable.getTwo() != null) {
				...
				currencyStockDataTable.setTwoAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getOne() != null) {
				...
				currencyStockDataTable.setOneAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getPointFive() != null) {
				...
				currencyStockDataTable.setPointFiveAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getPointTwoFive() != null) {
				...
				currencyStockDataTable.setPointTwoFiveAdj(modifySubTotal);
			}
			...
			if (currencyStockDataTable.getPointOne() != null) {
				...
				modifySubTotal = modifySubTotal.add(currencyStockDataTable
						.getPointZeroFives()
						.multiply(Constants.POINT_ZERO_FIVE));
				currencyStockDataTable.setPointZeroFiveAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getPointZeroTwo() != null) {
				...
				currencyStockDataTable.setPointZeroTwoAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getPointZeroOne() != null) {
				...
				currencyStockDataTable.setPointZeroOneAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getPointZeroZeroFive() != null) {
				...
				modifySubTotal = modifySubTotal.add(currencyStockDataTable
						.getPointZeroZeroFives().multiply(
								Constants.POINT_ZERO_ZERO_FIVE));
				currencyStockDataTable.setPointZeroZeroFiveAdj(modifySubTotal);
			}
			if (currencyStockDataTable.getPointZeroZeroOne() != null) {
				...
				modifySubTotal = modifySubTotal.add(currencyStockDataTable
						.getPointZeroZeroOnes().multiply(
								Constants.POINT_ZERO_ZERO_ONE));
				currencyStockDataTable.setPointZeroZeroOneAdj(modifySubTotal);
			}
		...
		try {
			...
			if (!documentSerilId.trim().equals("")) {
				...
				for (CurrencyStockDataTable cashTransferDTObj1 : currencyStockDataTableList) {
					...
					for (CurrencyStockDataTable cashTransferDTObj : currencyStockDataTableList) {
						...
						if ((cashTransferDTObj.getModRowTotal() == null ? BigDecimal.ZERO
							...
							if (getSaveType()
								...
								cashDetailList.add(saveCashDetail(
										cashTransferDTObj, cashHeader,
										saveDocumentSerialID, i,
										cashDetailsList.get(i - 1)
												.getCashDetailsId()));
					...
					try {
						// save in cash header , cash details and currency
						// adjust
						cashTransferLToLService.saveAllRecords(cashHeader,
								cashDetailList, foreignCurrencyAdjustList);
					...
					/*
					 * } else { RequestContext.getCurrentInstance().execute(
					 * "selectAmount.show();"); break; }
					 */
				}
			} else {
	...
	public void deleteCashDetails() {
		...
		if (cashList.size() > 0) {
			...
			List<ForeignCurrencyAdjust> currencyAdjustList = cashTransferLToLService
					.getForeignCurrencyAdjust(cashList.get(0).getDocumentNo());
			List<CashDetails> cashDetailsList = cashTransferLToLService
