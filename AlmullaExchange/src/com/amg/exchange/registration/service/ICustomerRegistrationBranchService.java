...
public interface ICustomerRegistrationBranchService<T> {
	...
	//Added By Naizsh for smart Card
	...
	//added by nazish for bahrain smart card parser
	...
	public List<String> getAreaforCorporate(String lowerCase);
	...
	//Call view  for getting Image ID
