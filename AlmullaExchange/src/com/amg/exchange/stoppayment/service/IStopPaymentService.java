...
public interface IStopPaymentService<T> {
	...
	//public HashMap<String, Object> fetchTransferDetails(BigDecimal companyCode,BigDecimal documentCode, BigDecimal documentYear, BigDecimal documentNo) throws AMGException;
