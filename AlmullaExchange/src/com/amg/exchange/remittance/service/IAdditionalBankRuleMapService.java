...
public interface IAdditionalBankRuleMapService {
	...
	public List<AdditionalBankRuleAmiec> getAdditionBankAlmullaCodeRecordsForView(BigDecimal countryId,String flexifiled);
	...
	//Added by kani for Enquiry Screen 
	...
	//Added By nazish for new development
	...
	public List<AmiecAndBankMapping>   checkRecordAvailableInAmiecAndBankMappingTable(BigDecimal countryId, String flexiField, String amiecCode, String amiecDesc,BigDecimal bankId);
