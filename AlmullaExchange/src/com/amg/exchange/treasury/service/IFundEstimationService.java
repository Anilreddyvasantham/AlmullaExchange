...
public interface IFundEstimationService<T> {
	...
	public List<FundEstimation> getFundEstimationDataForTomCash(BigDecimal appCountryId,BigDecimal bankCountryId,BigDecimal currencyId,BigDecimal bankId,Date projectionDate,BigDecimal fundEstimationId);
