...
@Entity
@Table(name="EX_WU_TERMS_CONDITIONS")
public class WUTermsAndConditions implements Serializable{
	...
	public WUTermsAndConditions(){
		
	}	
	
	public WUTermsAndConditions(BigDecimal temsId, BigDecimal lineNo,
	...
	@Id
	@Column(name = "EX_WU_TERMS_CONDITIONS_ID")
