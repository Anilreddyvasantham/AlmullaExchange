...
public class PasswordGenerator implements Serializable
{
	...
	// blocked 0 , o , O , I , l based user request
	...
	public static class PasswordGeneratorBuilder
	{
		 ...
		 *
		 * @param useLower
		 *           true in case you would like to include lower characters (abc...xyz). Default false.
		 ...
		 *
		 * @param useUpper
		 *           true in case you would like to include upper characters (ABC...XYZ). Default false.
		 * @return the builder for chaining.
		 */
		 ...
		 *
		 * @param useDigits
		 *           true in case you would like to include digit characters (123..). Default false.
		 * @return the builder for chaining.
		 */
		 ...
		 *           true in case you would like to include punctuation characters (!@#..). Default false.
		 * @return the builder for chaining.
		 */
	...
	/**
	 * This method will generate a password depending the use* properties you define. It will use the categories with a probability. It is not sure
