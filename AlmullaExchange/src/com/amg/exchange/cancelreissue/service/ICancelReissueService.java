package com.amg.exchange.cancelreissue.service;
...
public interface ICancelReissueService<T> {
	...
	public List<ViewRemiitanceInfo> fetchRemittanceDetailsFileUpload(BigDecimal appCountryId,BigDecimal companyId,BigDecimal DOCUMENTcODE, BigDecimal documentFinanceYear,BigDecimal documentNo,BigDecimal bankId);
