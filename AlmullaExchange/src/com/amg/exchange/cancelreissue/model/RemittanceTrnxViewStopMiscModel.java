 ...
 */
@Entity
@Table(name= "VW_EX_STOP_MISC_INFO")
public class RemittanceTrnxViewStopMiscModel implements Serializable {
	
	 
	private static final long serialVersionUID = 1L;
	
	/*IDNO                         NOT NULL NUMBER         
	...
	BRANCH_ID                             NUMBER         
	COUNTRY_BRANCH_NAME                   VARCHAR2(50)   
	DOCUMENT_DATE                         DATE           
	APPLICATION_FINANCE_YEAR              NUMBER(4)      
	APPLICATION_DOCUMENT_NO               NUMBER(14)     
	REMITTANCE_MODE_ID                    NUMBER         
	REMITTANCE_DESC                       VARCHAR2(120)  
	DELIVERY_MODE_ID                      NUMBER         
	DELIVERY_DESC                         VARCHAR2(40)   
	FOREIGN_CURRENCY_ID                   NUMBER         
	FOREIGN_CURRENCY_CODE                 VARCHAR2(4000) 
	FOREIGN_CURRENCY_DESC                 VARCHAR2(4000) 
	FOREIGN_TRANX_AMOUNT                  NUMBER(22,3)   
	QUOTE_NAME                            VARCHAR2(5)    
	LOCAL_CURRENCY_ID                     NUMBER         
	LOCAL_CURRENCY_CODE                   VARCHAR2(4000) 
	LOCAL_CURRENCY_DESC                   VARCHAR2(4000) 
	LOCAL_AMOUNT                          NUMBER(18,3)   
	...
	COLLECTION_DOC_ID                     NUMBER         
	COLLECTION_DOC_CODE                   NUMBER         
	COLLECTION_DOC_FINANCE_YEAR           NUMBER         
	COLLECTION_DOCUMENT_NO                NUMBER         
	BLACK_LIST_INDICATOR                  VARCHAR2(1)    
	SPOT_RATE_IND                         VARCHAR2(1)    
	LOYALTY_POINTS_IND                    VARCHAR2(1)    
	LOYALTY_POINTS_ENCASHED               NUMBER         
	HIGH_VALUE_TRANX                      VARCHAR2(1)    
	HIGH_VALUE_AUTHUSER                   VARCHAR2(80)   
	HIGH_VALUE_AUTHDAT                    DATE           
	CUSTOMER_REFERENCE                    NUMBER         
	SOURCE_OF_INCOME                      NUMBER         
	SOURCE_OF_INCOME_DESC                 VARCHAR2(100)  
	CREATED_DATE                          DATE           
	...
	BENEFICIARY_BANK_BRANCH_ID            NUMBER         
