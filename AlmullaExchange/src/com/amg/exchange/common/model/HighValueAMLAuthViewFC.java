...
@Entity
@Table(name="VW_EX_HV_AML_AUTH_FC")
public class HighValueAMLAuthViewFC implements Serializable{
	...
	private String forreignCurrenyName;
	...
	public String getForreignCurrenyName() {
		return forreignCurrenyName;
	}
	public void setForreignCurrenyName(String forreignCurrenyName) {
		this.forreignCurrenyName = forreignCurrenyName;
	}
