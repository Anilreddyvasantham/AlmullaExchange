package com.amg.exchange.miscellaneous.service;
...
public interface IMiscellaneousReceiptPaymentService<T> {
	...
	public List<ViewRemiitanceInfo>  fetchTransactionalDetail(BigDecimal appCountryId,BigDecimal companyId, BigDecimal documentCode,BigDecimal remittanceYear,BigDecimal remiitanceNo);
	...
	public List<ViewRemiitanceInfo> getAllTransactionsList(BigDecimal customerReference);
	...
	public void updateRecord(BigDecimal recpayPk ,BigDecimal comissionAmt,BigDecimal chargesAmt,BigDecimal deliverChargesAmt,BigDecimal rateAdjust,BigDecimal otherAdj,BigDecimal netAmt,String remarks);
	...
	public List<CustomerInfoView> getCustomerDetailsBasedOnRef(BigDecimal custRef);
