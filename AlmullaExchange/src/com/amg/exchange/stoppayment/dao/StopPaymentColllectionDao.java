...
public interface StopPaymentColllectionDao {
	RemittanceApplication viewBean(BigDecimal transferNo);

	RemittanceTransaction getTransactiondetailsbyDocumentNo(Long transferNo);

	String getProductName(BigDecimal bankId, BigDecimal remittanceModeId, BigDecimal deliveryModeId, BigDecimal corespondingCountryId, BigDecimal foreignCurrencyId);
