...
public interface IPersonalRemittanceService {
	...
	public List<BeneficaryAccount> getCustomerBeneficaryDetails(BigDecimal customerId);
	...
	public List<BeneficaryContact> isTelephoneExistInDB(BigDecimal telephone);
	...
	//public List<BeneficaryAccount> isBankAccountNumberExistInDb(BigDecimal bankAccountNumber, BigDecimal countryId, BigDecimal BankId, BigDecimal bankBranchId);
	...
	// get utilized amount from remittance Application table
	...
	// added by Nazish for dynamic drop down
	...
	// Start by Subramanian for Bene exception setup
	...
	// 25/03/2015 to get the currency form view
	...
	public List<ServiceGroupMasterDesc> fetchCashServiceGorupId(String cASHNAME, BigDecimal bigDecimal);
	...
	public List<BeneficaryRelationship> getCustomerBeneficaryDetailswithRelations(BigDecimal masterId);
	...
	public Map<String, Object> checkTelephoneExistWithCustIdwithPhone(BigDecimal mobileNumber, BigDecimal customerNo, String countryCode, String string);

	public List<BeneficaryRelationship> getRelationshipRecord(BigDecimal benificaryMasterId, BigDecimal beneficaryAccountSeqId);

	public List<BeneficaryAccount> isCashAccountExist(BigDecimal bankAccountNumber, BigDecimal benifisBankId, BigDecimal benifisCurrencyId, BigDecimal benifisCountryId);
	...
	public BigDecimal getbankIndicator(String bankIndicatorAgentBank, BigDecimal bigDecimal);
	...
	public List<DebitAutendicationView> getdebitAutendicationListByUserId(String colAuthorizedby, String string);
	...
	List<PopulateData> getBeneficaryList(BigDecimal customerNo);
	...
	public void deleteBeneAccountRecordPesonal(BigDecimal beneAccountSeqId,BigDecimal beneRelationSeqId,String status,String remarks);
	...
	public List<Collect>   checkDeclarationIndicatorsInCollectionTable(BigDecimal collctionDocNo,BigDecimal collectionYear);
